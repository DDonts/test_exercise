        ...
        if case:
            ...
            if 'new_description' in data:
                ...
                if case.description != data['new_description']:
                    logging_of_editing(field='Description', old=case.description, new=data['new_description'], case_id=case.id)
            ...
            if 'new_status' in data:
                if data['new_status'] in statuses:
                    if case.status_id != statuses[data['new_status']]:
                        logging_of_editing(field='Status', old=case.status.name, new=data['new_status'], case_id=case.id)
            ...
            if 'new_end_time' in data:
                ...
                if new_end_time < case.start_time:
                    ...
                    if str(case.end_time) != str(new_end_time):
                        logging_of_editing(field='end_time', old=str(case.end_time), new=str(new_end_time), case_id=case.id)
